...
realtime = L.realtime({
        url: 'https://janfreebeer.pythonanywhere.com/getfile/fanekartgps.geojson',
        crossOrigin: true,
        type: 'json'
    },
	{
...
realtimeLinje = L.realtime({
        url: 'https://janfreebeer.pythonanywhere.com/getfile/fanekartgps_kurve.geojson',
        crossOrigin: true,
        type: 'json'
    },
	{
...
realtime.on('update', function(e) {
        ...
        popupContent = function(fId) {
			...
			document.querySelector('#vegreferanse').innerHTML = feature.properties.name + timePretty['klokke'];
            return '<img src="images/clippy.png"><br>' +
			feature.properties.name + ' var her<br>' +
